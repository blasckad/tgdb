...
from analysis.temporal_graph_transformer import TGTTv3           # ← модель v3

# ===============  гиперпараметры  ========================================
H              = 64        # базовая размерность скрытых векторов
WINDOW         = 80        # длина последовательности событий на пользователя
...
model = TGTTv3(node_dim=H, dropout=0.2).to(device)
